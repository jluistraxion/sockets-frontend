...
function fnValidaEstructuraCurp(curp) {
  var re =
  ...
  function digitoVerificador(curp17) {
    ...
    if (lngDigito === 10) return '?'
    return lngDigito
  }
  if (validado[2] !== digitoVerificador(validado[1])) return '?'

  return curp //Validado
}
...
function parseaOcr(objetoData) {
  ...
  if (
    ...
    curpMB = fnValidaEstructuraCurp(objetoData.frontViz.personalIdNumber.latin)
  }
